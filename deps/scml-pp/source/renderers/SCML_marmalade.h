#ifndef _MARMALADE_RENDERER_H__
#define _MARMALADE_RENDERER_H__
...
class FileSystem : public SCML::FileSystem
{
    ...
    */
    SCML_MAP(SCML_PAIR(int, int), CIwTexture*) images;
    ...
    */
    ...
    /*! Get an image
    */
    CIwTexture* getImage(int folderID, int fileID) const;
...
class Entity : public SCML::Entity
{
    ...
    */
    ...
    CIwGxSurface* setScreen(CIwGxSurface* scr);
